...
class SfPdfViewerState extends State<SfPdfViewer> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    _scrollDirection = widget.pageLayoutMode == PdfPageLayoutMode.single ? PdfScrollDirection.horizontal : widget.scrollDirection;
  ...
  void didUpdateWidget(SfPdfViewer oldWidget) {
    ...
    _scrollDirection = widget.pageLayoutMode == PdfPageLayoutMode.single ? PdfScrollDirection.horizontal : widget.scrollDirection;
    _compareDocument(oldWidget._provider.getPdfBytes(context), widget._provider.getPdfBytes(context), oldWidget.password);
    if (oldWidget.pageLayoutMode != widget.pageLayoutMode && oldWidget.controller != null) {
      _updateOffsetOnLayoutChange(oldWidget.controller!.zoomLevel, oldWidget.controller!.scrollOffset, oldWidget.pageLayoutMode);
    }
  }
  ...
  Future<void> _compareDocument(Future<Uint8List> oldBytesData, Future<Uint8List> newBytesData, String? oldPassword) async {
  ...
  Future<void> _loadPdfDocument(bool isPdfChanged) async {
    try {
      ...
      _pdfBytes = _isEncrypted ? _decryptedBytes : (await _getPdfFileCancellableOperation?.value)!;
      if (isPdfChanged) {
        _reset();
        _plugin = PdfViewerPlugin();
        _checkMount();
      ...
      if (errorMessage.contains('Invalid cross reference table') ||
        ...
        if (widget.onDocumentLoadFailed != null) {
          widget.onDocumentLoadFailed!(PdfDocumentLoadFailedDetails('Format Error', 'This document cannot be opened because it is corrupted or not a PDF.'));
        }
            ...
            if (widget.onDocumentLoadFailed != null) {
              if (widget.password == '' || widget.password == null) {
                widget.onDocumentLoadFailed!(PdfDocumentLoadFailedDetails(
                    'Empty Password Error', 'The provided `password` property is empty so unable to load the encrypted document.'));
              } else {
                widget.onDocumentLoadFailed!(PdfDocumentLoadFailedDetails(
                    'Invalid Password Error', 'The provided `password` property is invalid so unable to load the encrypted document.'));
              }
            }
          }
        }
      ...
      //if the path is invalid
        ...
        if (widget.onDocumentLoadFailed != null) {
          widget.onDocumentLoadFailed!(
              PdfDocumentLoadFailedDetails('File Not Found', 'The document cannot be opened because the provided path or link is invalid.'));
        }
      } else {
        if (widget.onDocumentLoadFailed != null) {
          widget.onDocumentLoadFailed!(PdfDocumentLoadFailedDetails('Error', 'There was an error opening this document.'));
        }
      }
    } finally {
      _checkMount();
  ...
  Widget _showWebPasswordDialogue() {
    return Container(
      color: (_themeData!.colorScheme.brightness == Brightness.light) ? const Color(0xFFD6D6D6) : const Color(0xFF303030),
      child: Visibility(
        visible: _visibility,
        child: Center(
          child: Container(
            ...
            decoration: BoxDecoration(
                ...
                color: (_themeData!.colorScheme.brightness == Brightness.light) ? Colors.white : const Color(0xFF424242)),
            child: Column(
              children: <Widget>[
                Padding(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Text(
                        ...
                        style: _pdfViewerThemeData!.passwordDialogStyle?.headerTextStyle ??
                            TextStyle(
                              fontFamily: 'Roboto',
                              fontSize: 20,
                      ...
                      SizedBox(
                        ...
                        child: RawMaterialButton(
                          ...
                          child: Icon(
                            Icons.clear,
                            color: _pdfViewerThemeData!.passwordDialogStyle?.closeIconColor ?? _themeData!.colorScheme.onSurface.withOpacity(0.6),
                            size: 24,
                          ),
                        ),
                      ),
                ...
                Padding(
                  ...
                  child: Text(
                    ...
                    style: _pdfViewerThemeData!.passwordDialogStyle?.contentTextStyle ??
                        TextStyle(
                          fontFamily: 'Roboto',
                          fontSize: 16,
                ...
                SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintStyle: _pdfViewerThemeData!.passwordDialogStyle?.inputFieldHintTextStyle ??
                          TextStyle(
                            fontFamily: 'Roboto',
                            fontSize: 16,
                            fontWeight: FontWeight.w400,
                      ...
                      labelStyle: _pdfViewerThemeData!.passwordDialogStyle?.inputFieldLabelTextStyle ??
                          TextStyle(
                            fontFamily: 'Roboto',
                            fontSize: 18,
                            fontWeight: FontWeight.w500,
                            color: _errorTextPresent ? _themeData!.colorScheme.error : _themeData!.colorScheme.onSurface.withOpacity(0.87),
                          ),
                      errorStyle: _pdfViewerThemeData!.passwordDialogStyle?.errorTextStyle ??
                          TextStyle(
                            fontFamily: 'Roboto',
                            fontSize: 14,
                            fontWeight: FontWeight.w500,
                      ...
                      suffixIcon: IconButton(
                          icon: Icon(_passwordVisible ? Icons.visibility : Icons.visibility_off,
                              color: _pdfViewerThemeData!.passwordDialogStyle?.visibleIconColor ?? Theme.of(context).colorScheme.onSurface.withOpacity(0.6)),
                          onPressed: () {
                            setState(() {
                    ...
                    children: <Widget>[
                      TextButton(
                        ...
                        child: Text(
                          ...
                          style: _pdfViewerThemeData!.passwordDialogStyle?.cancelTextStyle ??
                              TextStyle(
                                fontFamily: 'Roboto',
                                fontSize: 14,
                                fontWeight: FontWeight.w500,
                      ...
                      TextButton(
                        ...
                        child: Text(
                          ...
                          style: _pdfViewerThemeData!.passwordDialogStyle?.openTextStyle ??
                              TextStyle(
                                fontFamily: 'Roboto',
                                fontSize: 14,
                                fontWeight: FontWeight.w500,
    ...
    try {
      ...
      if (widget.onDocumentLoadFailed != null) {
        if (password.isEmpty || _textFieldController.text.isEmpty) {
          widget.onDocumentLoadFailed!(
              PdfDocumentLoadFailedDetails('Empty Password Error', 'The provided `password` property is empty so unable to load the encrypted document.'));
        } else {
          widget.onDocumentLoadFailed!(
              PdfDocumentLoadFailedDetails('Invalid Password Error', 'The provided `password` property is invalid so unable to load the encrypted document.'));
        }
      }
      setState(() {
      ...
      builder: (BuildContext context) {
        ...
        return Directionality(
          ...
          child: AlertDialog(
            ...
            contentPadding: orientation == Orientation.portrait ? const EdgeInsets.all(24) : const EdgeInsets.only(right: 24, left: 24),
            buttonPadding: orientation == Orientation.portrait ? const EdgeInsets.all(8) : const EdgeInsets.all(4),
            backgroundColor:
                _pdfViewerThemeData!.backgroundColor ?? (Theme.of(context).colorScheme.brightness == Brightness.light ? Colors.white : const Color(0xFF424242)),
            title: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[
                Text(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: IconButton(
                                icon: Icon(_passwordVisible ? Icons.visibility : Icons.visibility_off,
                                    color:
                                        _pdfViewerThemeData!.passwordDialogStyle?.visibleIconColor ?? Theme.of(context).colorScheme.onSurface.withOpacity(0.6)),
                                onPressed: () {
                                  setState(() {
                                    _passwordVisible = !_passwordVisible;
                                  });
  ...
  void _isDocumentLoaded() {
    if (_pdfPages.isNotEmpty &&
      ...
      _isPdfPagesLoaded();
    } else if (_layoutChangeOffset != Offset.zero && (!_pdfDimension.isEmpty && _pdfScrollableStateKey.currentState != null)) {
      final double xOffset = widget.scrollDirection != PdfScrollDirection.vertical ? _pdfPages[_previousSinglePage]!.pageOffset : 0;
      final double yOffset = widget.scrollDirection == PdfScrollDirection.vertical ? _pdfPages[_previousSinglePage]!.pageOffset : 0;
      _pdfScrollableStateKey.currentState!.jumpTo(xOffset: xOffset + _layoutChangeOffset.dx, yOffset: yOffset + _layoutChangeOffset.dy);
  ...
  void _isPdfPagesLoaded() {
    if (_isDocumentLoadInitiated) {
      if (widget.initialScrollOffset == Offset.zero || _pdfViewerController._verticalOffset != 0.0 || _pdfViewerController._horizontalOffset != 0.0) {
        _pdfViewerController.jumpTo(xOffset: _pdfViewerController._horizontalOffset, yOffset: _pdfViewerController._verticalOffset);
      }
  ...
  Widget build(BuildContext context) {
    final Container emptyContainer = Container(
      color:
          _pdfViewerThemeData!.backgroundColor ?? (_themeData!.colorScheme.brightness == Brightness.light ? const Color(0xFFD6D6D6) : const Color(0xFF303030)),
    );
    final Stack emptyLinearProgressView = Stack(
      children: <Widget>[
        emptyContainer,
        LinearProgressIndicator(
          valueColor: AlwaysStoppedAnimation<Color>(_pdfViewerThemeData!.progressBarColor ?? _themeData!.colorScheme.primary),
              ...
              child: FutureBuilder(
                  ...
                  builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
                    if (snapshot.hasData) {
                      ...
                      _isKeyPadRaised = WidgetsBinding.instance.window.viewInsets.bottom != 0.0;
                      ...
                      if (_isKeyPadRaised) {
                        ...
                        if ((widget.scrollDirection == PdfScrollDirection.horizontal || widget.pageLayoutMode == PdfPageLayoutMode.single) &&
                            keyPadHeight > 0) {
                      ...
                      if (!_pdfDimension.isEmpty) {
                        if (_scrollDirection == PdfScrollDirection.vertical) {
                          _maxScrollExtent = _pdfDimension.height - (viewportDimension.height / _pdfViewerController.zoomLevel);
                        } else {
                          _maxScrollExtent = _pdfDimension.width - (viewportDimension.width / _pdfViewerController.zoomLevel);
                        }
                      }
                      Widget child;
                      final List<Widget> children = List<Widget>.generate(_pdfViewerController.pageCount, (int index) {
                        ...
                        final Size calculatedSize = _calculateSize(BoxConstraints(maxWidth: _viewportConstraints.maxWidth), _originalWidth![index],
                            _originalHeight![index], _viewportConstraints.maxWidth, viewportDimension.height);
                        ...
                        final PdfPageView page = PdfPageView(
                          ...
                          (kIsDesktop && !_isMobileView && !_isOverflowed && widget.pageLayoutMode == PdfPageLayoutMode.continuous)
                        ...
                        final double pageSpacing = index == _pdfViewerController.pageCount - 1 ? 0.0 : widget.pageSpacing;
                        if (kIsDesktop && !_isMobileView && !_isOverflowed) {
                          _pdfPages[pageIndex] = PdfPageInfo(totalHeight, Size(_originalWidth![index], _originalHeight![index]));
                          if (_scrollDirection == PdfScrollDirection.vertical && widget.pageLayoutMode != PdfPageLayoutMode.single) {
                            totalHeight += _originalHeight![index] + pageSpacing;
                          } else {
                            if (widget.pageLayoutMode == PdfPageLayoutMode.continuous) {
                              totalHeight += _originalWidth![index] + pageSpacing;
                            } else {
                        ...
                        if (_pdfPagesKey[_pdfViewerController.pageNumber]?.currentState?.canvasRenderBox != null && !_isTextSelectionCleared) {
                      ...
                      if (widget.pageLayoutMode == PdfPageLayoutMode.single) {
                        ...
                        if (_isSinglePageViewPageChanged && _renderedImages.contains(_pdfViewerController.pageNumber)) {
                          Future<dynamic>.delayed(Duration.zero, () async {
                            ...
                            if (getSelectedTextLines().isNotEmpty && getSelectedTextLines().first.pageNumber + 1 == _pdfViewerController.pageNumber) {
                        ...
                        if (_scrollDirection == PdfScrollDirection.horizontal) {
                          ...
                          child = Column(key: _childKey, mainAxisAlignment: MainAxisAlignment.center, children: children);
                        }
                        child = MouseRegion(
                          cursor: _cursor,
                          onHover: (PointerHoverEvent details) {
                      ...
                      return Stack(
                        children: <Widget>[
                          pdfContainer,
                          BookmarkView(_bookmarkKey, _document, _pdfViewerController, _handleBookmarkViewChanged, _textDirection),
                        ],
                      );
  ...
  Size _getChildSize(Size viewportDimension) {
    ...
    if (_pdfScrollableStateKey.currentState != null) {
      widthFactor =
          _pdfScrollableStateKey.currentState!.paddingWidthScale == 0 ? _pdfViewerController.zoomLevel : _pdfScrollableStateKey.currentState!.paddingWidthScale;
    ...
    if (_pdfPages[_pdfViewerController.pageCount] != null) {
      ...
      childWidth = viewportDimension.width > totalImageWidth ? viewportDimension.width / widthFactor.clamp(1, 3) : totalImageWidth / widthFactor.clamp(1, 3);
      ...
      childHeight =
          viewportDimension.height > totalImageHeight ? viewportDimension.height / heightFactor.clamp(1, 3) : totalImageHeight / heightFactor.clamp(1, 3);
      ...
      if (_isMobileView && childWidth > _viewportConstraints.maxWidth && totalImageWidth / zoomLevel <= _viewportConstraints.maxWidth) {
  ...
  List<PdfTextLine> getSelectedTextLines() {
    final List<PdfTextLine>? selectedTextLines = _pdfPagesKey[_pdfViewerController.pageNumber]?.currentState?.canvasRenderBox?.getSelectedTextLines();
  ...
  int _findStartOrEndPage(int pageIndex, bool isLastPage) {
    ...
    for (int start = isLastPage ? _pdfViewerController.pageCount : _pdfViewerController.pageNumber;
      ...
      pageSize += _scrollDirection == PdfScrollDirection.vertical ? _pdfPages[start]!.pageSize.height : _pdfPages[start]!.pageSize.width;
      ...
      final bool isPageIndexFound =
          _scrollDirection == PdfScrollDirection.vertical ? pageSize > _viewportConstraints.biggest.height : pageSize > _viewportConstraints.biggest.width;
      if (isPageIndexFound) {
        break;
      }
    }
  ...
  Future<Map<int, List<dynamic>>?>? _getImages() {
    if (widget.pageLayoutMode == PdfPageLayoutMode.single) {
      ...
      final int startPage = _pdfViewerController.pageNumber - 1 != 0 ? _pdfViewerController.pageNumber - 1 : _pdfViewerController.pageNumber;
      final int endPage =
          _pdfViewerController.pageNumber + 1 < _pdfViewerController.pageCount ? _pdfViewerController.pageNumber + 1 : _pdfViewerController.pageCount;
      final bool canRenderImage = !(_singlePageViewKey.currentState?.isScrollHeadDragged ?? true);
      renderedPages = _plugin
          .getSpecificPages(startPage, endPage, _pdfViewerController.zoomLevel, _isZoomChanged || (_isPageChanged && !_isOrientationChanged),
              _pdfViewerController.pageNumber, canRenderImage && !_isOrientationChanged)
      ...
      int startPage = (kIsDesktop && _pdfViewerController.pageNumber != 1) ? _pdfViewerController.pageNumber - 1 : _pdfViewerController.pageNumber;
      ...
      bool canRenderImage = !(_pdfScrollableStateKey.currentState?.scrollHeadStateKey.currentState?.isScrollHeadDragged ?? true) &&
      ...
      if (_pdfScrollableStateKey.currentState?.isZoomChanged ?? false) canRenderImage = true;
      renderedPages = _plugin
          .getSpecificPages(startPage, endPage, _pdfViewerController.zoomLevel, _isZoomChanged || (_isPageChanged && !_isOrientationChanged),
              _pdfViewerController.pageNumber, (canRenderImage || !_isDocumentLoadInitiated) && !_isOrientationChanged)
          .then((Map<int, List<dynamic>>? value) {
      ...
      if (_isOrientationChanged && widget.scrollDirection == PdfScrollDirection.horizontal && _deviceOrientation == MediaQuery.of(context).orientation) {
        _isOrientationChanged = false;
      }
      ...
      if ((_startPage != startPage && _endPage != endPage) || (_bufferCount > 0 && _bufferCount <= (endPage - startPage) + 1)) {
        renderedPages.whenComplete(_checkMount);
  ...
  void _updateSearchInstance({bool isNext = true}) {
    if (_textCollection != null &&
        ...
        _pdfViewerController.pageNumber != (_textCollection![_pdfViewerController._pdfTextSearchResult.currentInstanceIndex - 1].pageIndex + 1)) {
      _pdfViewerController._pdfTextSearchResult._currentOccurrenceIndex = _getInstanceInPage(_pdfViewerController.pageNumber, lookForFirst: isNext);
    }
  }
  ...
  void _updateOffsetOnOrientationChange(Offset initialOffset, int pageIndex, double totalHeight) {
    if (_viewportWidth != _viewportConstraints.maxWidth && _deviceOrientation != MediaQuery.of(context).orientation) {
      ...
      if (pageIndex == 1 && !_viewportConstraints.biggest.isEmpty && _pdfScrollableStateKey.currentState != null) {
        _offsetBeforeOrientationChange = Offset(_pdfScrollableStateKey.currentState!.currentOffset.dx / _pdfDimension.width,
        ...
        if (_pdfViewerController.pageCount == 1 && _pdfScrollableStateKey.currentState != null) {
          if (_viewportWidth != 0) {
            ...
            WidgetsBinding.instance.addPostFrameCallback((Duration timeStamp) {
              _pdfPagesKey[_pdfViewerController.pageNumber]?.currentState?.canvasRenderBox?.updateContextMenuPosition();
              _pdfScrollableStateKey.currentState?.forcePixels(Offset(initialOffset.dx * _viewportConstraints.biggest.width, targetOffset));
            });
          }
          ...
          WidgetsBinding.instance.addPostFrameCallback((Duration timeStamp) {
            ...
            if (_scrollDirection == PdfScrollDirection.vertical && widget.pageLayoutMode != PdfPageLayoutMode.single) {
              ...
              _pdfScrollableStateKey.currentState
                  ?.forcePixels(Offset(targetOffset, initialOffset.dy * _pdfPages[_pdfViewerController.pageNumber]!.pageSize.height));
            }
          });
        }
        _viewportWidth = _viewportConstraints.maxWidth;
  ...
  void _updateOffsetOnLayoutChange(double zoomLevel, Offset scrollOffset, PdfPageLayoutMode oldLayoutMode) {
    if (oldLayoutMode != widget.pageLayoutMode && oldLayoutMode == PdfPageLayoutMode.single) {
      ...
      if (kIsDesktop && !_isMobileView) {
        heightPercentage = _document!.pages[_pdfViewerController.pageNumber - 1].size.height / _pdfPages[_pdfViewerController.pageNumber]!.pageSize.height;
      }
      ...
      Future<dynamic>.delayed(Duration.zero, () async {
        ...
        if (widget.pageLayoutMode == PdfPageLayoutMode.single && _singlePageViewKey.currentState != null) {
          ...
          if (_viewportConstraints.maxHeight > _pdfPages[_pdfViewerController.pageNumber]!.pageSize.height * _pdfViewerController.zoomLevel) {
            _singlePageViewKey.currentState!
                .jumpOnZoomedDocument(_pdfViewerController.pageNumber, Offset(xPosition / heightPercentage, yPosition / heightPercentage));
          } else {
            _singlePageViewKey.currentState!
                .jumpOnZoomedDocument(_pdfViewerController.pageNumber, Offset(xPosition / heightPercentage, (yPosition + greyAreaHeight) / heightPercentage));
          }
        }
      });
    }
  ...
  void _updateScrollDirectionChange(Offset initialOffset, int pageIndex, double totalHeight) {
        ...
        if (_viewportWidth != 0) {
          WidgetsBinding.instance.addPostFrameCallback((Duration timeStamp) async {
            ...
            if (_pdfViewerController.zoomLevel <= 1) {
              ...
              if (_scrollDirection == PdfScrollDirection.vertical && widget.pageLayoutMode != PdfPageLayoutMode.single) {
                final dynamic pageOffset = _pdfPages[_pdfViewerController.pageNumber]!.pageOffset;
                final dynamic calculatedOffsetY = pageOffset + (initialOffset.dy * _pdfPages[_pdfViewerController.pageNumber]!.pageSize.height);
                final dynamic calculatedOffsetX = (_pdfScrollableStateKey.currentState!.currentOffset.dx - _pageOffsetBeforeScrollDirectionChange) *
                    (_pdfPages[_pdfViewerController.pageNumber]!.pageSize.width / _pageSizeBeforeScrollDirectionChange.width);

                _scrollDirectionSwitchOffset = Offset(calculatedOffsetX, calculatedOffsetY);
              } else {
                final dynamic pageOffset = _pdfPages[_pdfViewerController.pageNumber]!.pageOffset;
                final dynamic calculatedOffsetX = pageOffset + (initialOffset.dx * _pdfPages[_pdfViewerController.pageNumber]!.pageSize.width);
                final dynamic calculatedOffsetY = (_pdfScrollableStateKey.currentState!.currentOffset.dy - _pageOffsetBeforeScrollDirectionChange) /
                    (_pageSizeBeforeScrollDirectionChange.height / _pdfPages[_pdfViewerController.pageNumber]!.pageSize.height);
    ...
    } else if (widget.pageLayoutMode == PdfPageLayoutMode.continuous || widget.pageLayoutMode != PdfPageLayoutMode.single) {
  ...
  Size _calculateSize(BoxConstraints constraints, double originalWidth, double originalHeight, double newWidth, double newHeight) {
    if (_viewportConstraints.maxWidth > newHeight &&
      ...
      if (widget.pageLayoutMode == PdfPageLayoutMode.single && (!_isMobileView || _viewportConstraints.maxWidth > newHeight)) {
        constraints = BoxConstraints.tightFor(
          height: newHeight,
        ).enforce(constraints);
      } else {
    ...
    if ((widget.pageLayoutMode == PdfPageLayoutMode.single ||
            widget.scrollDirection == PdfScrollDirection.horizontal && Orientation.portrait == MediaQuery.of(context).orientation) &&
  ...
  void _jumpToBookmark(PdfBookmark? bookmark) {
    if (bookmark != null && _document != null) {
      ...
      final bool isRotatedTo90or270 = pdfPage.rotation == PdfPageRotateAngle.rotateAngle90 || pdfPage.rotation == PdfPageRotateAngle.rotateAngle270;
      if (bookmark.namedDestination != null) {
        heightPercentage = bookmark.namedDestination!.destination!.page.size.height / (isRotatedTo90or270 ? revealedOffset.width : revealedOffset.height);
        widthPercentage = bookmark.namedDestination!.destination!.page.size.width / (isRotatedTo90or270 ? revealedOffset.height : revealedOffset.width);
        bookmarkOffset = bookmark.namedDestination!.destination!.location;
      } else {
        heightPercentage = bookmark.destination!.page.size.height / (isRotatedTo90or270 ? revealedOffset.width : revealedOffset.height);
        widthPercentage = bookmark.destination!.page.size.width / (isRotatedTo90or270 ? revealedOffset.height : revealedOffset.width);
      ...
      if (_pdfPagesKey[_pdfViewerController.pageNumber]!.currentState != null &&
        ...
        bookmarkOffset =
            _pdfPagesKey[_pdfViewerController.pageNumber]!.currentState!.canvasRenderBox!.getRotatedOffset(bookmarkOffset, index - 1, pdfPage.rotation);
      }
  ...
  void _handleControllerValueChange({String? property}) {
    if (property == 'jumpToBookmark') {
      ...
      if (widget.pageLayoutMode == PdfPageLayoutMode.continuous) {
        if (_pdfScrollableStateKey.currentState != null) {
          _pdfViewerController._zoomLevel = _pdfScrollableStateKey.currentState!.scaleTo(_pdfViewerController.zoomLevel);
          ...
          PageStorage.of(context)?.writeState(context, _pdfViewerController.zoomLevel, identifier: 'zoomLevel_${widget.key}');
        }
      } else {
        if (_singlePageViewKey.currentState != null) {
      ...
      if (widget.pageLayoutMode == PdfPageLayoutMode.single) {
        ...
        _pdfScrollableStateKey.currentState?.jumpTo(xOffset: _pdfViewerController._horizontalOffset, yOffset: _pdfViewerController._verticalOffset);
      }
      ...
      switch (_pdfViewerController._pageNavigator!.option) {
        case Navigation.jumpToPage:
          if (_pdfViewerController._pageNavigator!.index! > 0 && _pdfViewerController._pageNavigator!.index! <= _pdfViewerController.pageCount) {
  ...
  void _jumpToSearchInstance({bool isNext = true}) {
    ...
    final int currentInstancePageIndex = _textCollection![_pdfViewerController._pdfTextSearchResult.currentInstanceIndex - 1].pageIndex + 1;
    ...
    if (_pdfPagesKey[_pdfViewerController.pageNumber]?.currentState?.canvasRenderBox != null) {
      topOffset = _pdfPagesKey[_pdfViewerController.pageNumber]!
          .currentState!
          .canvasRenderBox!
          .getRotatedTextBounds(_textCollection![_pdfViewerController._pdfTextSearchResult.currentInstanceIndex - 1].bounds, currentInstancePageIndex - 1,
              _document!.pages[currentInstancePageIndex - 1].rotation)
          .topLeft;
    }
    final double heightPercentage = (kIsDesktop && !_isMobileView && !_isOverflowed && widget.pageLayoutMode == PdfPageLayoutMode.continuous)
        ? 1
        : _document!.pages[currentInstancePageIndex - 1].size.height / _pdfPages[currentInstancePageIndex]!.pageSize.height;

    final double widthPercentage = (kIsDesktop && !_isMobileView && !_isOverflowed && widget.pageLayoutMode == PdfPageLayoutMode.continuous)
        ? 1
    ...
    double searchOffsetY = (_pdfPages[currentInstancePageIndex]!.pageOffset + (topOffset.dy / heightPercentage)) - searchInstanceTopMargin;
    ...
    final Rect viewport = Rect.fromLTWH(offset.dx, offset.dy - searchInstanceTopMargin, _viewportConstraints.biggest.width / _pdfViewerController.zoomLevel,
    ...
    final Rect singleLayoutViewport = Rect.fromLTWH(singleLayoutOffset.dx, singleLayoutOffset.dy,
        _viewportConstraints.biggest.width / _pdfViewerController.zoomLevel, _viewportConstraints.biggest.height / _pdfViewerController.zoomLevel);
    if (widget.pageLayoutMode == PdfPageLayoutMode.single) {
      if (!singleLayoutViewport
              .contains(Offset(topOffset.dx / widthPercentage, (topOffset.dy / heightPercentage) + _singlePageViewKey.currentState!.greyAreaSize)) ||
          currentInstancePageIndex != _pdfViewerController.pageNumber) {
        _singlePageViewKey.currentState!
            .jumpOnZoomedDocument(currentInstancePageIndex, Offset(topOffset.dx / widthPercentage, topOffset.dy / heightPercentage));
      }
      WidgetsBinding.instance.addPostFrameCallback((Duration timeStamp) {
        if (_isPageChanged) {
          _isPageChanged = false;
      ...
      if (property == 'nextInstance') {
        setState(() {
          _pdfViewerController._pdfTextSearchResult._currentOccurrenceIndex =
              _pdfViewerController._pdfTextSearchResult.currentInstanceIndex < _pdfViewerController._pdfTextSearchResult._totalInstanceCount
        ...
        setState(() {
          _pdfViewerController._pdfTextSearchResult._currentOccurrenceIndex = _pdfViewerController._pdfTextSearchResult.currentInstanceIndex > 1
              ? _pdfViewerController._pdfTextSearchResult.currentInstanceIndex - 1
  ...
  void _handlePdfOffsetChanged(Offset offset) {
    ...
    if (widget.pageLayoutMode == PdfPageLayoutMode.single && _pageController.hasClients) {
      _pdfViewerController._scrollPositionX = _pageController.offset;
    } else {
